...
class App extends Component {
  ...
  removeItems = countryId => {
    this.setState(prevState => {
      ...
      const updatedInitialCountriesList = prevState.initialCountries.map(
        country => {
  ...
  onClickVisitCountries = countryId => {
    this.setState(prevState => {
      const updatedCountriesList = prevState.initialCountries.map(country => {
        if (country.id === countryId) {
      ...
      const visitedCountry = prevState.initialCountries.find(
        country => country.id === countryId,
      )

      return {
        initialCountries: updatedCountriesList,
        visitedCountriesList: [...prevState.visitedCountries, visitedCountry],
      }
    })
  }
